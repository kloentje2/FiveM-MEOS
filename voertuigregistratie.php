  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <ol class="breadcrumb">
		...
		<?php if ($_SESSION['role'] != 'anwb') { ?>
		<a style="color:white;" href="voertuiginformatie" class="btn btn-block btn-primary"><h1>Politie</h1></a><br>
		<a style="color:white;" href="#" class="btn btn-block btn-primary"><h1>BlueBrick</h1></a><br>
		<?php } ?>
	  </div>
    <!-- /.container-fluid-->
    <!-- /.content-wrapper-->
